    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="assets/image/logo.png" alt="Bootstrap" width="200" height="100">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Pendaftaran.html">Daftar Wisata</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="daftar_pesanan.html">Ubah Pesanan</a>
            </li>
            <li class="nav-item">
          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisci elit, sed eiusmod tempor incidunt
                  ut
                  labore et dolore
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="text-center ratio ratio-16x9">
              <iframe src="https://www.youtube.com/embed/xeFaACENF0s?si=xYRDDa_NDOnLu3Y9" title="YouTube video player"
                frameborder="0"
